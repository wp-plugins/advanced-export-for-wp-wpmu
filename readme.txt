...
Working with a single large export file can be difficult. Use this plugin to create multiple export files that contain sections of your blog. This plugin has been tested on WP versions 2.7 - 2.8 & WPMU 2.7.X. The plugin may work on earlier versions of WP/WPMU. 
